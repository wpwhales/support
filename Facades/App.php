 ...
 * @method static \WPWhales\Foundation\Application setBasePath(string $basePath)
 * @method static string path(string $path = '')
 * @method static \WPWhales\Foundation\Application useAppPath(string $path)
 * @method static string basePath(string $path = '')
 * @method static string bootstrapPath(string $path = '')
 * @method static \WPWhales\Foundation\Application useBootstrapPath(string $path)
 * @method static string configPath(string $path = '')
 * @method static \WPWhales\Foundation\Application useConfigPath(string $path)
 * @method static string databasePath(string $path = '')
 * @method static \WPWhales\Foundation\Application useDatabasePath(string $path)
 * @method static string langPath(string $path = '')
 * @method static \WPWhales\Foundation\Application useLangPath(string $path)
 * @method static string publicPath(string $path = '')
 * @method static \WPWhales\Foundation\Application usePublicPath(string $path)
 * @method static string storagePath(string $path = '')
 * @method static \WPWhales\Foundation\Application useStoragePath(string $path)
 * @method static string resourcePath(string $path = '')
 * @method static string viewPath(string $path = '')
 * @method static string joinPaths(string $basePath, string $path = '')
 * @method static string environmentPath()
 * @method static \WPWhales\Foundation\Application useEnvironmentPath(string $path)
 * @method static \WPWhales\Foundation\Application loadEnvironmentFrom(string $file)
 ...
 * @method static \WPWhales\Support\ServiceProvider register(\WPWhales\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \WPWhales\Support\ServiceProvider|null getProvider(\WPWhales\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\WPWhales\Support\ServiceProvider|string $provider)
 * @method static \WPWhales\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static \WPWhales\Foundation\Application addAbsoluteCachePathPrefix(string $prefix)
 * @method static \WPWhales\Contracts\Foundation\MaintenanceMode maintenanceMode()
 * @method static bool isDownForMaintenance()
 * @method static never abort(int $code, string $message = '', array $headers = [])
 * @method static \WPWhales\Foundation\Application terminating(callable|string $callback)
 ...
 * @method static \WPWhales\Contracts\Container\ContextualBindingBuilder when(array|string $concrete)
 ...
 * @method static \WPWhales\Foundation\Application getInstance()
 * @method static \WPWhales\Contracts\Container\Container|\WPWhales\Foundation\Application setInstance(\WPWhales\Contracts\Container\Container|null $container = null)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \WPWhales\Foundation\Application
 */
