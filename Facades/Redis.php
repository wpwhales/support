...
/**
 * @method static \WPWhales\Redis\Connections\Connection connection(string|null $name = null)
 * @method static \WPWhales\Redis\Connections\Connection resolve(string|null $name = null)
 ...
 * @method static \WPWhales\Redis\RedisManager extend(string $driver, \Closure $callback)
 * @method static void createSubscription(array|string $channels, \Closure $callback, string $method = 'subscribe')
 * @method static \WPWhales\Redis\Limiters\ConcurrencyLimiterBuilder funnel(string $name)
 * @method static \WPWhales\Redis\Limiters\DurationLimiterBuilder throttle(string $name)
 ...
 * @method static \WPWhales\Redis\Connections\Connection setName(string $name)
 ...
 *
 * @see \WPWhales\Redis\RedisManager
 */
