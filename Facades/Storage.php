 ...
 * @method static \WPWhales\Contracts\Filesystem\Filesystem disk(string|null $name = null)
 * @method static \WPWhales\Contracts\Filesystem\Cloud cloud()
 * @method static \WPWhales\Contracts\Filesystem\Filesystem build(string|array $config)
 * @method static \WPWhales\Contracts\Filesystem\Filesystem createLocalDriver(array $config)
 * @method static \WPWhales\Contracts\Filesystem\Filesystem createFtpDriver(array $config)
 ...
 * @method static bool put(string $path, \Psr\Http\Message\StreamInterface|\WPWhales\Http\File|\WPWhales\Http\UploadedFile|string|resource $contents, mixed $options = [])
 ...
 * @method static string|false putFile(\WPWhales\Http\File|\WPWhales\Http\UploadedFile|string $path, \WPWhales\Http\File|\WPWhales\Http\UploadedFile|string|array|null $file = null, mixed $options = [])
 * @method static string|false putFileAs(\WPWhales\Http\File|\WPWhales\Http\UploadedFile|string $path, \WPWhales\Http\File|\WPWhales\Http\UploadedFile|string|array|null $file, string|array|null $name = null, mixed $options = [])
